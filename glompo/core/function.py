...
class BaseFunction:
    ...
    def detailed_call(self, x: Sequence[float]) -> Sequence[Any]:
        """ Optional function evaluation method. When called with a parameter vector (`x`) it returns a sequence
            of data. The first element of this sequence is expected to be the function evaluation result (as returned by
            :meth:`__call__`). Subsequent elements of the sequence may take any form. This function may be used to
